...
const calendar = bookingCalendars.personalInjury;

export const metadata: Metadata = {
  title: "Citas de Personal Injury",
  description:
    "Agenda tu consulta de lesiones personales en El Abogado Judío. Elige el horario disponible en NY, NJ y CT.",
};

export default function PersonalInjuryCitasPage() {
  return (
    <>
      <CinematicPageHero
