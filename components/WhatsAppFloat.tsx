...
export default function WhatsAppFloat() {
  ...
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.95 }}
      className="fixed bottom-5 right-5 z-40 flex h-12 w-12 items-center justify-center rounded-full border border-gold bg-ink text-gold shadow-[0_10px_28px_rgba(0,0,0,0.45)]"
    >
      <svg
        viewBox="0 0 24 24"
        fill="currentColor"
