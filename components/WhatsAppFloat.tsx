...
export default function WhatsAppFloat() {
  ...
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.95 }}
      className="fixed bottom-5 right-5 z-40 flex h-14 w-14 items-center justify-center overflow-visible rounded-full border border-gold bg-ink text-gold shadow-[0_10px_28px_rgba(0,0,0,0.45)] max-[480px]:bottom-[max(1.25rem,env(safe-area-inset-bottom))] max-[480px]:right-[max(1.25rem,env(safe-area-inset-right))]"
    >
      <svg
        viewBox="0 0 24 24"
        fill="currentColor"
